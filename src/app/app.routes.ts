...
export const routes: Routes = [
    ...
    {path:"editprofile",component:ProfileFormComponent,canActivate: [authGuard],data: { role: '*' }},
    {path:"showprofile/:userId",component:ShowprofileComponent,canActivate: [authGuard],data: { role: '*' }},
